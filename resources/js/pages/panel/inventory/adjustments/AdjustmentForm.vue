...
const form = reactive({
  ...
  type: 'adjustment',
  items: [
    { product_id: '', quantity: 0, current_quantity: 0, reason: 'recount' }
  ]
});
...
function addItem() {
  form.items.push({ product_id: '', quantity: 0, current_quantity: 0, reason: 'recount' });
}

function handleWarehouseChange() {
  form.items = [{ product_id: '', quantity: 0, current_quantity: 0, reason: 'recount' }];
}
